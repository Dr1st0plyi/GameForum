...
exports.AuthModule = exports.jwtModuleOptionsFactory = void 0;
...
const jwtModuleOptionsFactory = (configService) => ({
    secret: configService.getOrThrow('JWT_SECRET'),
    signOptions: { expiresIn: '1h' },
});
exports.jwtModuleOptionsFactory = jwtModuleOptionsFactory;
    ...
    (0, common_1.Module)({
        imports: [
            ...
            jwt_1.JwtModule.registerAsync({
                ...
                useFactory: exports.jwtModuleOptionsFactory,
